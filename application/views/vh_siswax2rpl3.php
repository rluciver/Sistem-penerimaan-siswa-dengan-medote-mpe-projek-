...
// Perintah jQuery yang dijalankan pada versi jQuery_2_2_3
    ...
    table = jQuery_2_2_3('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('index.php/h_siswax2rpl3/ajax_list')?>",
            "type": "POST"
        },
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('index.php/h_siswax2rpl3/ajax_add')?>";
    } else {
        url = "<?php echo site_url('index.php/h_siswax2rpl3/ajax_update')?>";
    }
...
function delete_siswa(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('index.php/h_siswax2rpl3/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
    ...
    <script>
     $(document).ready(function(e){
        ...
        var input = $("input[name=nama_siswa]");
            ...
            $.get('http://localhost/projek/index.php/home9/json_search_country', function(data){
                        input.typeahead({
                            source: data,
                            minLength: 1,
                        });
