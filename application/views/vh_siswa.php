                         ...
                         <div class="form-group">
                            ...
                            <div class="col-md-7">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <option value="2">Tidak ada</option>></select>
                                    <span class="help-block"></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                ...
                                <div class="col-md-6">
                                    <select class="form-control "name="nilai_prestasi">
                                    <option value="">SILAHKAN PILIH</option>
                                    <option value="3">Patuh</option>
                                    <option value="2">Tidak Patuh</option>></select>
                                    <span class="help-block"></span>
                                </div>
                            </div>
                        </div>
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-md-7">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <option value="2">Sering terlambat</option>></select>
                                    <span class="help-block"></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                ...
                                <div class="col-md-6">
                                    <select class="form-control "name="nilai_prestasi">
                                    <option value="">SILAHKAN PILIH</option>
                                    <option value="3">Tidaak mengikuti pelajaran</option>
                                    <option value="2">Mengikuti pelajaran</option>></select>
                                    <span class="help-block"></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <option value="">SILAHKAN PILIH</option>
                                    <option value="3">Selalu hadir</option>
                                    <option value="2">Jarang Hadir</option></select>
                                    <span class="help-block"></span>
                                </div>
                            </div>
                        </div>
