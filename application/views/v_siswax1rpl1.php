...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('index.php/siswax1rpl1/ajax_list')?>",
            "type": "POST"
        },
...
function edit_siswa(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('index.php/siswax1rpl1/ajax_edit/')?>/" + id,
        type: "GET",
        dataType: "JSON",
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('index.php/siswax1rpl1/ajax_add')?>";
    } else {
        url = "<?php echo site_url('index.php/siswax1rpl1/ajax_update')?>";
    }
...
function delete_siswa(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('index.php/siswax1rpl1/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
