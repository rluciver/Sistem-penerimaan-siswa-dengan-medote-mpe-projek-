...
class ksclaporan_beasiswa7 extends CI_Controller {
    /*****
   ...
   public function index(){
        ...
        $this->load->view('v_report/vlaporan_beasiswa7');
    ...
    public function cetak(){
        ...
        $data['databeasiswa'] = $this->m_cetaksiswa->getAllItem3XIII1($tahun); //query model semua barang
 
        $this->load->view('v_report/vcetak_laporan_beasiswa7', $data);
