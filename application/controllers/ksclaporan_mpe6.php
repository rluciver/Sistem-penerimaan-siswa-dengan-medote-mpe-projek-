...
class ksclaporan_mpe6 extends CI_Controller {
    /*****
   ...
   public function index(){
        ...
        $this->load->view('v_report/vlaporan_mpe6');
    ...
    public function cetak(){      
        $tahun              = $this->input->post('tahun');    
        $data['datampe']    = $this->m_cetaksiswa->getAllItem2XII3($tahun); 
        $data['title']      = 'Cetak PDF Data Perhitungan MPE';  
        //query model semua barang 
        $this->load->view('v_report/vcetak_laporan_mpe6', $data);
