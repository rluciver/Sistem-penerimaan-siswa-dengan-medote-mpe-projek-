...
class ksclaporan_mpe3 extends CI_Controller {
    /*****
   ...
   public function index(){
        ...
        $this->load->view('v_report/vlaporan_mpe3');
    ...
    public function cetak(){      
        $tahun              = $this->input->post('tahun');    
        $data['datampe']    = $this->m_cetaksiswa->getAllItem2XI3($tahun); 
        $data['title']      = 'Cetak PDF Data Perhitungan MPE';  
        //query model semua barang 
        $this->load->view('v_report/vcetak_laporan_mpe3', $data);
