...
class ksclaporan_beasiswa5 extends CI_Controller {
    /*****
   ...
   public function index(){
        ...
        $this->load->view('v_report/vlaporan_beasiswa5');
    ...
    public function cetak(){
        ...
        $data['databeasiswa'] = $this->m_cetaksiswa->getAllItem3XII2($tahun); //query model semua barang
 
        $this->load->view('v_report/vcetak_laporan_beasiswa5', $data);
