...
class ksclaporan_beasiswa9 extends CI_Controller {
    /*****
   ...
   public function index(){
        ...
        $this->load->view('v_report/vlaporan_beasiswa9');
    ...
    public function cetak(){
        ...
        $data['databeasiswa'] = $this->m_cetaksiswa->getAllItem3XIII3($tahun); //query model semua barang
 
        $this->load->view('v_report/vcetak_laporan_beasiswa9', $data);
