...
class ksc_cetaksiswa4 extends CI_Controller {
    /*****
    ...
    *****/
    ...
    public function index(){
        ...
        $this->load->view('v_report/v_formcetaksiswa4');
        $this->load->view('footer');
    }

    public function cetak(){      
        $tahun             = $this->input->post('tahun');    
        $data['datasiswa'] = $this->m_cetaksiswa->getAllItemXI1($tahun); 
        
        $data['title'] = 'Cetak PDF Data Siswa';  
        //query model semua barang 
        $this->load->view('v_report/v_cetak_laporan_siswa4', $data);
