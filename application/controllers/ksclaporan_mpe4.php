...
class ksclaporan_mpe4 extends CI_Controller {
    /*****
   ...
   public function index(){
        ...
        $this->load->view('v_report/vlaporan_mpe4');
    ...
    public function cetak(){      
        $tahun              = $this->input->post('tahun');    
        $data['datampe']    = $this->m_cetaksiswa->getAllItem2XII1($tahun); 
        $data['title']      = 'Cetak PDF Data Perhitungan MPE';  
        //query model semua barang 
        $this->load->view('v_report/vcetak_laporan_mpe2', $data);
