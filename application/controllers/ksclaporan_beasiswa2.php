...
class ksclaporan_beasiswa2 extends CI_Controller {
    /*****
   ...
   public function index(){
        ...
        $this->load->view('v_report/vlaporan_beasiswa2');
    ...
    public function cetak(){
        ...
        $data['databeasiswa'] = $this->m_cetaksiswa->getAllItem3XI2($tahun); //query model semua barang
 
        $this->load->view('v_report/vcetak_laporan_beasiswa2', $data);
