...
class ksc_cetaksiswa7 extends CI_Controller {
    /*****
    ...
    *****/
    ...
    public function index(){
        ...
        $this->load->view('v_report/v_formcetaksiswa7');
        $this->load->view('footer');
    }

    public function cetak(){      
        $tahun             = $this->input->post('tahun');    
        $data['datasiswa'] = $this->m_cetaksiswa->getAllItemXII1($tahun); 
        
        $data['title'] = 'Cetak PDF Data Siswa';  
        //query model semua barang 
        $this->load->view('v_report/v_cetak_laporan_siswa7', $data);
