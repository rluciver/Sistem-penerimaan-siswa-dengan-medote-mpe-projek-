...
class ksc_cetaksiswa9 extends CI_Controller {
    /*****
    ...
    *****/
    ...
    public function index(){
        ...
        $this->load->view('v_report/v_formcetaksiswa9');
        $this->load->view('footer');
    }

    public function cetak(){      
        $tahun             = $this->input->post('tahun');    
        $data['datasiswa'] = $this->m_cetaksiswa->getAllItemXIII3($tahun); 
        
        $data['title'] = 'Cetak PDF Data Siswa';  
        //query model semua barang 
        $this->load->view('v_report/v_cetak_laporan_siswa9', $data);
