...
class ksclaporan_beasiswa3 extends CI_Controller {
    /*****
   ...
   public function index(){
        ...
        $this->load->view('v_report/vlaporan_beasiswa3');
    ...
    public function cetak(){
        ...
        $data['databeasiswa'] = $this->m_cetaksiswa->getAllItem3XI3($tahun); //query model semua barang
 
        $this->load->view('v_report/vcetak_laporan_beasiswa3', $data);
